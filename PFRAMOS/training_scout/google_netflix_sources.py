"""Google and Netflix source registry for the PACC Scout programme.

Google Research is an active dataset-discovery source. Netflix Open Source is
an active code, artifact and publication-discovery source. A Netflix resource
is treated as a training dataset only when the specific data release has an
explicit compatible licence and accessible provenance record.
"""
