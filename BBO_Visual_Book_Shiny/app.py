...
app_ui = ui.page_navbar(
    ...
    ui.nav_panel(
        ...
        ui.div(
            ...
            ui.div(
                ui.h2("Visual Storyboard Navigation Tree"),
                ui.p("Select a parent section or one of its indented branches."),
                ui.div(
                    ui.div(
                        ui.input_action_button("contents_bbo", "1. Imperial BBO", class_="visual-tree-parent"),
                        ui.div(
                            ui.input_action_button("contents_week", "1.1 Read by Week", class_="visual-tree-child"),
                            ui.input_action_button("contents_function", "1.2 Read by Function", class_="visual-tree-child"),
                            ui.input_action_button("contents_atlas", "1.3 Scientific Atlas", class_="visual-tree-child"),
                            class_="visual-tree-children",
                        ),
                        class_="visual-tree-branch",
                    ),
                    ui.div(ui.input_action_button("contents_executive", "2. Executive Summary", class_="visual-tree-parent"), class_="visual-tree-branch"),
                    ui.div(ui.input_action_button("contents_repository", "3. Repository", class_="visual-tree-parent"), class_="visual-tree-branch"),
                    ui.div(
                        ui.input_action_button("contents_above", "4. Above and Beyond", class_="visual-tree-parent"),
                        ui.div(
                            ui.input_action_button("contents_bbr", "4.1 Black Box Resolution", class_="visual-tree-child"),
                            ui.input_action_button("contents_pdhis", "4.2 PDHIS", class_="visual-tree-child"),
                            class_="visual-tree-children",
                        ),
                        class_="visual-tree-branch",
                    ),
                    ui.div(ui.input_action_button("contents_evidence", "5. Evidence", class_="visual-tree-parent"), class_="visual-tree-branch"),
                    class_="visual-navigation-tree",
                ),
    ...
    ui.nav_panel(
        ...
        ui.div(
            ...
            ui.div(
                ...
                class_="executive-audio-nav executive-audio-nav-top",
            ),
