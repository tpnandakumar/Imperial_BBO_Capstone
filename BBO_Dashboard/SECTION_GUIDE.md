...
This folder preserves the canonical dataset and analytical resources used to reproduce the official thirteen-round Imperial BBO Challenge record. The public interactive edition is the [Shiny Visual Book](../BBO_Visual_Book_Shiny/SECTION_GUIDE.md).
