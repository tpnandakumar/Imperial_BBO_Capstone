...
- [Week 13 RL-Informed Decision Experiment](RL_DECISION_EXPERIMENT/SECTION_GUIDE.md)
...
The [Week 13 RL-Informed Decision Experiment](RL_DECISION_EXPERIMENT/SECTION_GUIDE.md) executes this policy against the verified Week 1 to Week 12 evidence. It reproduces the final action pattern and then evaluates those actions using the returned Week 13 outputs.
