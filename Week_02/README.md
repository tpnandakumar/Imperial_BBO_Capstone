...
Overall, Week 2 represented a clear progression from initial exploration towards a more informed optimisation strategy. The Week 1 outputs provided valuable information that enabled promising regions to be identified for exploitation while highlighting areas that required further exploration. By balancing information gain and performance improvement, the Week 2 strategy aimed to improve both understanding of the search space and the quality of future optimisation decisions. The process demonstrated the importance of adapting optimisation behaviour as evidence accumulates and reinforced the value of balancing exploration and exploitation when working with unknown black-box functions.
