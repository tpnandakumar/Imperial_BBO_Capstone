...
The increasing dimensionality of the functions also influenced my thinking. Higher-dimensional functions contain substantially larger search spaces, making optimisation more challenging. A single observation provides relatively little information in a six-dimensional or eight-dimensional search space compared with a two-dimensional problem. Consequently, higher-dimensional functions required greater caution when balancing exploration and exploitation. The risk of missing important regions increases as dimensionality grows, making information gathering particularly valuable.
